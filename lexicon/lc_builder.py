...
if __name__ == '__main__':  
    ...
    parser.add_argument('--size', type=str, action='store', dest='csi', metavar='<parameter>', required=False, help='[optional] size of chain chunk for fixed chains')
    ...
    #in_foname = 'C:/tmp_project/ChainBuilder/input_fllc'
    #ch_select = 'fixed'# FLLC - flex; FXLC - fixed;
    #chunk_size = '' #size of chain for fixed
